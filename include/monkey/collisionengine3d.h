...
// 3D spatial collision engine
class SpatialHashingCollisionEngine3D : public ICollisionEngine {
public:
	~SpatialHashingCollisionEngine3D() override;
	explicit SpatialHashingCollisionEngine3D (const ITab&);
