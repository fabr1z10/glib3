...
//
//CollisionEngine3D::CollisionEngine3D (const ITable& t) : ICollisionEngine()
//{
...
//
//
//ShapeCastHit CollisionEngine3D::ShapeCast (Shape* shape, const glm::mat4& transform, int mask) {
//    ShapeCastHit result;
...
//
//                // bounding boxes intersect, so let's make a proper collision test
////                auto report = m_intersector->intersect(s1, t1, s2, t2);
////                if (report.collide) {
//////                    CollisionInfo ci;
//////                    ci.report = report;
