strings = {
    ...
    ui = {
        ...
        giveprep = "to",
        useprep = "with",
		pause_message = "Jeu Arrêté. Appuyez sur SPACE pour continuer."
    },
    objects = {
        stairs = "escalier",
        path = "sentier",
        ...
        door = "porte",
        lookout = "guetteur",
		cliffside = "bord de falaise",
		meat = "morceau de viande",
		pot = "marmite",
		fish = "fish",
		potostew = "marmite de ragoût",
		meatstew = "ragoût de viande",
        stewedmeat = "stewed meat",
		barrel = "barrel",
		kitchen_table = "table",
		fireplace = "cheminée",
		ilp = "conseil des pirates",
		dog = "chien",
		pirate = "pirate",
		pirates = "pirates",
		archway = "arche",
		citizen = "Citoyen de Mêlée",
		lowmoralfiber = "homme à la morale douteuse",
    ...
    dialogues = {
        lookout = {
        	[1] = "On m'a dit qu'il y avait une petite fete ici.",
            [2] = "Je voudrais me divertir. Qu'est-ce qu'il y a à faire ici?",
            [3] = "Qu'est-ce qui est vert et poilu et a mille jambes?",
            [4] = "J'ai parfois l'impression que la vie est un jeu. Et toi?",
            [5] = "Tu veux me faire avoir une crise cardiaque!",
            [6] = "Tu m'as fait peur.",
            [7] = "Je croyais que tu étais--",
            [8] = "--peu importe.",
            [9] = "Au fait, comment tu t'appelles?",
            [10] = "Je m'appelle Guybrush Threephwood.",
            [11] = "Appelle-moi Squinky.",
            [12] = "I'm over this way.",
            [13] = "Who are YOU?",
            [14] = "I'll just be off to seek my fortune now.",
            [15] = "Eh?",
            [16] = "Oh.",
            [17] = "Je suis venu sur cette île pour devenir pirate.",
            [18] = "Hé bien, tu as choisi le bon endroit.",
            [19] = "Mais sans aucun doute le mauvais moment.",
		...
		lowmoralfiber = {
			[1] = "Quel beau rat!",
			[2] = "Tu peux supporter d'être à côté de cette vermine?",
			[3] = "Do you guys know the sneaky-looking man on the opposite corner?",
			[4] = "Dites-donc les gars, vous etes pirates?",
			[5] = "Bien, je dois y aller maintenant.",
			[6] = "Aimes-tu les rats?",
			[7] = "Oui, j'adore les rats!",
			[8] = "Non, j'en ai horreur.",
			[9] = "Oui, particulièrement dans une sauce légère de vin blanc.",
			[10] = "Je n'ai pas le temps de faire la causette. Il faut que j'aille.",
			[11] = "Ce sont des créatures trés intelligentes!",
			[12] = "Ha ha ha ha!!",
			[13] = "Plus intelligentes que LUI.",
			[14] = "Il parait qu'une bande de rats est partie un bateau vers la famouse Ile aux-Singes.",
			[15] = "Non, ce n'est pas vrai.",
			[16] = "C'était en fait une bande de singes.",
			[17] = "Vraiment étonnant!",
			[18] = "C'est dur à croire.",
			[19] = "Une bande de singes idiots ne peut pas naviguer en bateau!",
			[20] = "Je m'excuse, mais je dois partir.",
			[21] = "Mais vrai.",
			[22] = "A leur arrivée, ils ont vendu le bateau pour une grosse somme.",
			[23] = "C'est bien la prèmiere fois que le vieux Stan s'est fait avoir.",
			[24] = "Je croyas que c'était des rats.",
			...
			[41] = "But it's true.",
			[42] = "OK, that's fair.",
			[43] = "Non, nous faisons partie d'une troupe de cirque.",
			[44] = "Mais le rat a fait peur à l'éléphant.",
			[45] = "Evidemment nous sommes des pirates!",
			[46] = "Tu crois que tu peux trouver des vetemens comme ca en pret a porter?",
			[47] = "What do you want?",
    ...
    village1 = {
        [1] = "Réélisez le Gouverneur Marley.",
        [2] = "\"Quand il n'y a qu'un seul candidat, il n'y a qu'un seul choix.\""
    },
	kitchen = {
		[1] = "On dirait quelque chose qui ressemble à de la viande.",
		[2] = "Quelqu'un a cuisiné un fromage de tête à l'intérieur.",
		[3] = "Je crois que c'est un hareng.",
		[4] = "I think that bird will peck my hand off...",
		[5] = "Elle boue.",
		[6] = "Je crois qu'il est plein de cette boisson infame que les pirates boivent.",
		[7] = "Aie!",
		[8] = "Je l'ai attrapé!",
		[9] = "Hmm. Stewed meat."
	},
