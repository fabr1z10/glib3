           ...
           { 
	           {
					duration = dt,
                    quads = {
			    		{ x = 0, y = 0, width = 118, height = 127, anchor = {60, 0}}
					}
		       },
		   }
		}
...
scene = {
	{
		...
		children = {
		{
			--gfx = {shape={type="rect", width=2, height=1, offset={-1,-0.5}}, color={255,255,255,255} },
			gfx = { model ="walking_guy", anim="default" },
			collider= {shape={type="rect", width=2, height=1, offset ={-1,-0.5}}, tag=1, flag=1},
			...
			follow = {
                cam ="maincam",
                relativepos={0, -20, 7.5},
                up={0,0,1}
		    }
	    }, 
	    { gfx = { model ="tree", anim="default" }, billboard = {cam="maincam"}, pos={50, 50, 0}},
	    { gfx = { model ="tree", anim="default" }, billboard = {cam="maincam"}, pos={70, 60, 0}},
	    { gfx = { model ="tree", anim="default" }, billboard = {cam="maincam"}, pos={20, 80, 0}},
