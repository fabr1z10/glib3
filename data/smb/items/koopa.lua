		...
		components = {
			...
			{ type="statemachine", initialstate = "walk",
				states = {
					...
					{ id = "shell", init = { type="animcollider", anim="shell", activate={} }},
					{ id = "shellfly", init = { type="animcollider", anim="shell", activate={"enemycollider"} }, behavior= {type="enemywalk2d", speed=100, dir= args.dir, flip=false }},					
				}
			}
		},
		children = {
			{ name="koopa", components = { {type="collider", shape=s, tag=goombaTag, flag=4}, {type="gfx", shape=s, color = {255,0,0,255} }}},
			{ name="shell", components = { {type="collider", shape=s, tag=goombaTag, flag=4}, {type="gfx", shape=s, color = {255,0,0,255} }}},
