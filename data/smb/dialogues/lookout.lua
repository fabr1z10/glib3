...
function dialoguesLookout.start(i) 
	 ...
	 s:add (say { character = "guybrush", lines = { d[i] } })
	 s:add (turn { character = "lookout", face = "south"} )
	 if (variables.talkedToLookout == false) then
	 	s:add (say { character = "lookout", lines = { d[5], d[6], d[7], d[8], d[9] } })
	 else
		s:add (say { character = "lookout", lines = { d[5], strings.dialogues.lookout.randomLookoutMsg() } })
	 end
...
function dialoguesLookout.iamguybrush() 
	 ...
	 s = Script.create("_dial")
	 s:add (say { character = "guybrush", lines = { d[10], d[17] } })
	 s:add (say { character = "lookout", lines = { d[18], d[19], d[20], d[21] } })
	 s:add ({{ type = "callfunc", func = curry(startDialogue, { dialogueId="lookout", nodeId=2 })}})
	 s:setsequence()
	 return s
end
...
function dialoguesLookout.whatiswrong() 
	 s = Script.create("_dial")
	 s:add (say { character = "guybrush", lines = { d[22] } })
	 s:add (say { character = "lookout", lines = { d[23], d[24], d[25], d[26] } })
	 s:add ({{ type = "callfunc", func = curry(startDialogue, { dialogueId="lookout", nodeId=2 })}})
	 s:setsequence()
	 return s
end
...
function dialoguesLookout.iamhere()
	 s = Script.create("_dial")
	 s:add (say { character = "guybrush", lines = { d[12] } })
	 s:add (turn { character = "lookout", face = "east"} )
	 s:add (say { character = "lookout", lines = { d[15], d[16] } })
	 s:add ({{ type = "callfunc", func = curry(startDialogue, { dialogueId="lookout", nodeId=2 })}})
	 s:setsequence()
	 return s
end
...
function dialoguesLookout.goodbye() 
	 ...
	 s:add (say { character = "lookout", lines = { d[42] } })
	 s:add (turn { character = "lookout", face = "west"} )
...
function dialoguesLookout.squinky() 
	 ...
	 if (variables.lookoutKnowsName == false) then
	 	s:add (say { character = "lookout", lines = { d[41] } })
	 else 
	 	s:add (say { character = "lookout", lines = { d[27] } })
	 	s:add (say { character = "guybrush", lines = { d[28] } })
	 	s:add (say { character = "lookout", lines = { d[29] } })
	 end
	 s:add ({{ type = "callfunc", func = curry(startDialogue, { dialogueId="lookout", nodeId=2 })}})
	 s:setsequence()
	 return s
...
function dialoguesLookout.whoareu()
	 ...
	 s:add (say { character = "lookout", lines = { d[30], d[31], d[32], d[33] } })
	 s:add ({{ type = "callfunc", func = curry(startDialogue, { dialogueId="lookout", nodeId=2 })}})
	 s:setsequence()
	 return s	
end
...
function dialoguesLookout.govworried()
	 ...
	 s:add (say { character = "lookout", lines = { d[35], d[36], d[37] } })
	 s:add ({{ type = "callfunc", func = curry(startDialogue, { dialogueId="lookout", nodeId=2 })}})
	 s:setsequence()
	 return s	
end
...
function dialoguesLookout.bat()
	 s = Script.create("_dial")
	 s:add (say { character = "guybrush", lines = { d[38] } })
	 s:add (say { character = "lookout", lines = { d[39], d[40] } })
	 s:add ({{ type = "callfunc", func = curry(startDialogue, { dialogueId="lookout", nodeId=2 })}})
	 s:setsequence()
	 return s	
end
...
function dialoguesLookout.thatsthreep()
	 s = Script.create("_dial")
	 s:add (say { character = "guybrush", lines = { d[47] } })
	 s:add (say { character = "lookout", lines = { d[49] } })
	 s:add ({{ type = "callfunc", func = curry(startDialogue, { dialogueId="lookout", nodeId=2 })}})
	 s:setsequence()
	 return s	
end