...
State.addItem(Item(
    ...
    dir = 'e',
    actions = {
        'open': ssc.openDoor (doorId='scummbar.door.kitchen', var = 'scummbar_kitchen'),
        'close': ssc.closeDoor (doorId='scummbar.door.kitchen', var = 'scummbar_kitchen'),
...
State.addItem(Item(
    ...
    width = 30, 
    height = 30,
    walkto = var.scummbar_mancomb_pos,
    dir = 'n',
    actions = {
        'look': ssc.changeRoom(room = 'mancomb'),
        'talk': ssc.changeRoom(room = 'mancomb')
    }
))
