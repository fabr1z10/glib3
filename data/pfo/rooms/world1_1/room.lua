					...
					{	
						...
						components = {
							...
							-- 		{ id = "walk", init = { type="luaanim", func = curry21(marioinit, "walk") }, behavior = { type ="walk2d", acceleration = marioAcc, speed= marioSpeed }},
							 		...
							 		{ id = "lowkick", state = { type="hit", anim="lowkick", frame = 2, shape = {type="rect", width=10, height=10}}},
							 		--{ id = "jkick", state = { type="hitj", anim="lowkick", frame = 2, shape = {type="rect", width=10, height=10}}}
							...
							-- 		{ id = "nophys", init = { type="luaanim", func = curry21(marioinit2, "idle") } }
								...
								keys = {
									{ id = 299, func = function() print ("ciao") end }
