strings = {
    ...
    dialogues = {
		...
		fester = {
			...
			[6] = "Oh really? That's interesting. Well, see ya.",
			[7] = "Did you hear something back in here too?",
			[8] = "Yeah, and bad things happen to people who sneak up on other people from behind.",
			[9] = "Now, why are you in such a hurry?",
			[10] = "I'd better get your name.",
			[11] = "I'm Guybrush Threepwood, and I'm a mighty pirate.",
			[12] = "I'm Guybrush Threepwood, and I'm new in town.",
			[13] = "I'm Guybrush Threepwood, and I was just leaving.",
			[14] = "Listen Peepwood--",
			[15] = "Threepwood!",
			[16] = "Guybrush Threepwood.",
			[17] = "Whatever your name is, listen:",
			[18] = "I'm the sheriff around here.",
			[19] = "Sheriff Fester Shinetop.",
			[20] = "Take it from me--This is a bad time to be visiting Mêlée Island™.",
			[21] = "A very BAD time.",
			[22] = "My advice for you is to find somewhere else to take your vacation.",
			[23] = "Somewhere safer.",
			[24] = "Boy, I feel much better knowing there's an officer of the law around.",
			[25] = "No.",
			[26] = "So, you're going to give me a little attitude, eh?"
