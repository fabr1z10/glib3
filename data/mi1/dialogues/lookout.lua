...
local initDialogue = function(n) 
	return function() 
		...
		if not variables.talked_to_lookout then
			...
			table.insert (actions, { type = scumm.action.say, args = {tag="lookout.lookout", lines = {d[5], d[6], d[7], d[8], d[9]}}})
		else
			table.insert (actions, { type = scumm.action.say, args = {tag="lookout.lookout", lines = {d[5], d[43] .. d[53+math.random(0,1)]}}})
		end
		return actions
	end
end
...
local lookout_turn = {
	...
	{ type = scumm.action.say, args = {tag="lookout.lookout", lines = {d[15], d[16]}}},
}
...
engine.dialogues.lookout = {
	...
	nodes = {
		...
		[6] = { text = d[10], active =true,
		 	script = { 
		 		{ type = scumm.action.say, args = { tag="player", lines = {d[10],d[17]} }}, 
		 		{ type = scumm.action.say, args = { tag="lookout.lookout", lines = {d[18], d[19], d[20], d[21]} }} 
		 	},
		...
		[7] = { text = d[11], active=true, script = {
				{ type = scumm.action.say, args = { tag="player", lines = {d[11]}}},
		 		{ type = scumm.action.say, args = { tag="lookout.lookout", lines = {d[41]}}}
		 	},
		 	deact ={6, 7,12}, 
		 	act = {13},
		 	children = {13, 8, 9, 10} 
		...
		[9] = { text = d[13], active=true, script = {
				{ type = scumm.action.say, args = { tag="player", lines = {d[13]}}},
		 		{ type = scumm.action.say, args = { tag="lookout.lookout", lines = {d[30], d[31], d[32]}}}
		 	},
		...
		[10] = { text = d[14], active=true, script = {
				{ type = scumm.action.say, args = { tag="player", lines = {d[14]}}},
		 		{ type = scumm.action.say, args = { tag="lookout.lookout", lines = {d[42]}}}
			}
		},
		[11] = { text = d[22], active=true, script = {
				{ type = scumm.action.say, args = { tag="player", lines = {d[22]}}},
		 		{ type = scumm.action.say, args = { tag="lookout.lookout", lines = {d[23], d[24], d[25], d[26], d[27]}}}
		 	},
		 	children = {}
		},
		...
		[12] = { text = d[11], active=false, deact= {12, 7}, script = { 
				{ type = scumm.action.say, args = { tag="player", lines = {d[11]}}},
		 		{ type = scumm.action.say, args = { tag="lookout.lookout", lines = {d[27]}}},
				{ type = scumm.action.say, args = { tag="player", lines = {d[28]}}},
		 		{ type = scumm.action.say, args = { tag="lookout.lookout", lines = {d[29]}}}
		 	},
		 	children = {8, 9, 10}  
		},
		[13] = { text = d[48], active=false, deact= {13}, script = { 
				{ type = scumm.action.say, args = { tag="player", lines = {d[48], d[17]}}},
		 		{ type = scumm.action.say, args = { tag="lookout.lookout", lines = {d[18], d[19], d[20], d[21], d[51]}}}
		 	},
		 	children = {8, 9, 10}
		},
		[14] = { text=d[34], active=false, script = {
				{ type = scumm.action.say, args = { tag="player", lines = {d[34]}}},
		 		{ type = scumm.action.say, args = { tag="lookout.lookout", lines = {d[35], d[36], d[37]}}}
			},
		 	children = {15, 10},
		 	deact = {14} 
		},
		[15] = { text=d[38], active=false, script = {
				{ type = scumm.action.say, args = { tag="player", lines = {d[38]}}},
		 		{ type = scumm.action.say, args = { tag="lookout.lookout", lines = {d[39], d[40]}}}
			},
		 	children = {14, 10},
		 	deact = {15} 
		},
