...
local f = function(n) 
	return {
		...
		{ type = scumm.action.say, args = { tag="fester", lines = { d[14]}}},
		{ type = scumm.action.say, args = { tag="player", lines = { d[15], d[16]}}},
		{ type = scumm.action.say, args = { tag="fester", lines = { d[17], d[18], d[19], d[20], d[21], d[22]}}},
		{ type = scumm.action.walkto, args = { tag="fester", pos ={100,10}}},
		{ type = scumm.action.turn, args = { tag="fester", dir="east" }},
		{ type = scumm.action.say, args = { tag="fester", lines = { d[23]}}},
...
engine.dialogues.fester = {
	...
	nodes = {
		...
		[2] = { text = d[6], active=true, children={5, 6, 7}, script = {
			{ type = scumm.action.say, args = { tag="player", lines = { d[6]}}},
			{ type = scumm.action.walkto, args = { tag="fester", pos ={160,10}}},
			{ type = scumm.action.say, args = { tag="fester", lines = { d[9], d[10]}}},
		} },
		[3] = { text = d[7], active=true, children={5, 6, 7}, script = {
			{ type = scumm.action.say, args = { tag="player", lines = { d[7]}}},
			{ type = scumm.action.walkto, args = { tag="fester", pos ={160,10}}},
			{ type = scumm.action.say, args = { tag="fester", lines = { d[25], d[10]}}},
		} },
		[4] = { text = d[8], active=true, children={5, 6, 7}, script = {
			{ type = scumm.action.say, args = { tag="player", lines = { d[8]}}},
			{ type = scumm.action.walkto, args = { tag="fester", pos ={160,10}}},
			{ type = scumm.action.say, args = { tag="fester", lines = { d[26], d[10]}}},
		} },
