...
dialogues.mancomb = {
	...
	nodes = {
		...
		[2] = { text = d[3], active=true, children = {6,7,8,9}, script = { fguy({3}), fman({9}), fman({10, 11}, "smile") }},
		[3] = { text = d[4], active=true, deact={3}, children = {2, 14, 5}, script = { fguy({4}), fman({29, 30, 24, 25, 26}) }},
		[4] = { text = d[5], active=true, deact={5}, children = {21,22,23}, script = { fguy({5}), fman({40, 41})}},
		...
		[21] = { text = d[42] },
		[22] = { text = d[43] },
		[23] = { text = d[44], script = { fguy({44}), fman({6, 7})}},
