...
local s1 = {
	...
	{ type = scumm.action.say, args = {actor="village2.citizen", lines = {d[23]}, animstart="talk_e", animend="idle_e"}},
...
engine.dialogues.citizen = {
	...
	nodes = {
		...
		[12] = { 
			...
			script = {
				{ ref=1, type=scumm.action.say, args={actor = "guybrush",  lines = {d[36]} }},
				{ type=action.animate, after= {1}, args={tag = "player",  anim="operate_e" }},
				{ ref=2, type=scumm.action.say, after = {1}, args = {actor="village2.citizen", animstart="givemap", animend="idle_e", lines = {d[37]}}},
				{ type=action.animate, after= {2}, args={tag = "player",  anim="idle_e" }},
				{ type=scumm.action.say, after = {2}, args = {actor="village2.citizen", animstart="talk_s", animend="idle_s", lines = {d[38]}}},
