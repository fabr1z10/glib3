...
def default_room(desc: dict):
    ...
    main.camera = cam.OrthoCamera(width, height, cam_width, vars.main_height, [0, vars.ui_height, cam_width, vars.main_height], tag='maincam')
    ...
    ui2.camera = cam.OrthoCamera(cam_width, vars.ui_height, cam_width, vars.ui_height, [0, 0, cam_width, vars.ui_height], tag='uicam')
